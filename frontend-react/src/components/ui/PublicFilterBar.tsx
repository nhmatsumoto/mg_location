...
export function PublicFilterBar({ countryFilter, setCountryFilter, locationFilter, setLocationFilter }: PublicFilterBarProps) {
  return (
    <HStack
      flex={1}
      maxW="700px"
    ...
    >
      <InputGroup size="sm">
        ...
        >
          <option value="" style={{ background: '#0A0B10' }}>
            Global Region
          </option>
          <option value="Brasil" style={{ background: '#0A0B10' }}>
            Brasil
          </option>
          <option value="Japão" style={{ background: '#0A0B10' }}>
            Japão
          </option>
        </Select>
      </InputGroup>
