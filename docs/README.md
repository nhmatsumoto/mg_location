...
- [Agente de orquestração MG Location](./agents/sos-location-orchestration-agent.md)
- [Catálogo expandido de agentes especialistas](./agents/specialist-agents-catalog.md)
- [Skills especialistas adicionadas](../skills/README.md)
- [Template de Requirement Card (skill)](../skills/sos-location-orchestration/references/requirement-card-template.md)
- [Matriz de roteamento agente-skill](../skills/sos-location-orchestration/references/agent-skill-routing-matrix.md)
