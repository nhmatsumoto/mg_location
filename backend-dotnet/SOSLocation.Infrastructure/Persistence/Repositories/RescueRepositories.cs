...
namespace SOSLocation.Infrastructure.Persistence.Repositories
{
    public class SearchAreaRepository : ISearchAreaRepository
    {
        ...
        public async Task<IEnumerable<SearchArea>> GetByIncidentIdAsync(int incidentId)
        {
        ...
        public async Task<int> AddAsync(SearchArea area)
        {
    ...
    public class AssignmentRepository : IAssignmentRepository
    {
        ...
        public async Task<IEnumerable<Assignment>> GetByIncidentIdAsync(int incidentId)
        {
